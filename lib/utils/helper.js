...
function generateCardHtml(url) {
  return "<iframe class=\"m-auto w-full\" src=\"https://hatenablog-parts.com/embed?url=".concat(encodeURIComponent(url), "\" frameborder=\"0\" scrolling=\"no\" loading=\"lazy\"></iframe></div>");
}
